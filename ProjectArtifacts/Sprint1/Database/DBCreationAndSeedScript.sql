...
INSERT INTO Employee (
    Id, SupervisorId, DepartmentId, JobAssignmentId, Password, PasswordSalt,
    FirstName, LastName, MiddleInitial,
    StreetAddress, City, Province, PostalCode,
    DOB, SIN, SeniorityDate, JobStartDate,
    WorkPhone, CellPhone, EmailAddress, OfficeLocation, EmploymentStatus
)
VALUES
-- CEO (no supervisor)
('00000001', NULL, NULL, 1, '24388386653dd1434991cb75d3669a8b7b8361c87986110575b4e88e35c66504', 0xE0187C6A4AD19746F368CFAA1FB93FCF, 'Alice', 
'Brown', 'J', '100 King St', 'Moncton', 'NB', 'E1A1A1', '1980-01-01', '111-111-111', '2005-01-01', '2005-01-01', 
'(506) 111-1111', '(506) 911-1111', 'alice.brown@example.com', 'HQ', 'Active'),

-- HUMAN RESOURCES DEPARTMENT (ID: 1)
-- HR Manager (Supervisor 1 for HR dept)
('00000002', '00000001', 1, 2, 'a5b6d7c1bfbc023930e33f8b0f2658b782a80a19251e9885c6468cb823037930', 0x7D1384BECD09A7091F3CC453EE18A5FE, 'Bob', 
'Smith', NULL, '101 King St', 'Moncton', 'NB', 'E1A1A2', '1985-02-01', '111-111-112', '2006-02-01', '2006-02-01', 
'(506) 222-1111', '(506) 922-1111', 'bob.smith@example.com', 'HQ', 'Active'),

-- HR Manager (Supervisor 2 for HR dept)
('00000003', '00000001', 1, 2, 'b12db4f06d40c58197aee70dedda8ddfe23663d043306af1469f760af9da55e3', 0x5A6885A5C69A9D8FB337B21AC80D8016, 'Cathy', 
'Mills', 'A', '102 King St', 'Moncton', 'NB', 'E1A1A3', '1986-03-01', '111-111-113', '2007-03-01', '2007-03-01', 
'(506) 333-1111', '(506) 933-1111', 'cathy.mills@example.com', 'East Wing', 'Active'),

-- HR Employees under Bob (Supervisor 1)
('00000004', '00000002', 1, 7, 'd98be886ae2f7d60f5c2fd7118d287db1d49e5503a6c8479ec125b7826e0553a', 0xB50B8BA20BDEDD2EDF7B1CFBA649AC71, 'David', 
'Nguyen', 'B', '103 King St', 'Moncton', 'NB', 'E1A1A4', '1987-04-01', '111-111-114', '2008-04-01', '2008-04-01', 
'(506) 444-1111', '(506) 944-1111', 'david.nguyen@example.com', 'East Wing', 'Active'),


('00000025', '00000002', 1, 7, '17633902ff551a9c83e59d8ae85a3528830860ef9c7a5a3117052157a017955d', 0x733495B08C9DD15756CCB24981A04BAD, 'Maria',
'Gomez', 'F', '123 Maple St', 'Moncton', 'NB', 'E1A2B3', '1990-02-15', '121-111-127', '2015-05-01', '2015-05-01',
'(506) 999-0000', '(506) 977-0000', 'maria.gomez@example.com', 'South Office', 'Active'),

-- HR Employees under Cathy (Supervisor 2)
('00000008', '00000003', 1, 7, '992745aae07edbc2ca167ab2d4c5166dd86b0b46adecd31f7e9f8219090a9dce', 0xF61E8EBD4C9762ACAF62134F73317B27, 'Henry', 
'Lee', 'E', '107 King St', 'Moncton', 'NB', 'E1A1A8', '1991-08-01', '111-111-118', '2012-08-01', '2012-08-01', 
'(506) 888-1111', '(506) 988-1111', 'henry.lee@example.com', 'North Office', 'Active'),
...
('00000005', '00000001', 2, 3, '688cf7c1d297f6f57a61fdf4a67d22c88c4b0dc9655ef9eb2cc0c6a84cf23ea7', 0xE3B2563309C47C3D38591FF40C843113, 'Ella', 
'Thomas', 'C', '104 King St', 'Moncton', 'NB', 'E1A1A5', '1988-05-01', '111-111-115', '2009-05-01', '2009-05-01', 
'(506) 555-1111', '(506) 955-1111', 'ella.thomas@example.com', 'West Wing', 'Active'),

-- Project Manager (Supervisor 2 for PM dept)
('00000010', '00000001', 2, 3, 'c08724bac9e850482980b50b84710655f82c8c364b0619fc0febeaa04eed12f9', 0xB7B51BC0DC6D995B6D3D6A42D8D2DAD6, 'Jack', 
'Wells', 'G', '109 King St', 'Moncton', 'NB', 'E1A1B0', '1993-10-01', '111-111-120', '2014-10-01', '2014-10-01', 
'(506) 101-1111', '(506) 201-1111', 'jack.wells@example.com', 'HQ', 'Active'),

-- PM Employees under Ella (Supervisor 1)
('00000009', '00000005', 2, 16, '6a1338e1a4126fe7ffe29e502eb1929ad593e7829b4672bac738faa98848fbfd', 0xA23F0532ACD00320B3089613DA1D898A, 'Ivy', 
'Turner', 'F', '108 King St', 'Moncton', 'NB', 'E1A1A9', '1992-09-01', '111-111-119', '2013-09-01', '2013-09-01', 
'(506) 999-1111', '(506) 999-2111', 'ivy.turner@example.com', 'North Office', 'Active'),

-- PM Employees under Jack (Supervisor 2)
('00000011', '00000010', 2, 16, '139a68e3eabb3431239fc09da45ec70f8a382de36b92477a58f784e06b0c3c7c', 0xDDB9309EFD90F0632459ACFF4C31554F, 'Karen', 
'Young', NULL, '110 Queen St', 'Moncton', 'NB', 'E1A2A1', '1994-01-01', '111-111-121', '2015-01-01', '2015-01-01', 
'(506) 202-1111', '(506) 302-1111', 'karen.young@example.com', 'HQ', 'Active'),

-- SOFTWARE DEVELOPMENT DEPARTMENT (ID: 3)
-- Developer Manager (Supervisor 1 for SD dept)
('00000006', '00000001', 3, 5, '473fd7135581560f373b891acbe8d89d984b7dadafdb444219ff95624f8a343e', 0x23C16FBA7D1015052DDB09AE1ED07F2B, 'Frank', 
'Olsen', NULL, '105 King St', 'Moncton', 'NB', 'E1A1A6', '1989-06-01', '111-111-116', '2010-06-01', '2010-06-01', 
'(506) 666-1111', '(506) 966-1111', 'frank.olsen@example.com', 'West Wing', 'Active'),

-- Developer Manager (Supervisor 2 for SD dept)
('00000007', '00000001', 3, 5, '526914124ad8c6714f1781b73051523e54526ed593c922376435898dc844ca6c', 0xE6F540157C5CEAE8D99D685B19AD0281, 'Grace', 
'Martin', 'D', '106 King St', 'Moncton', 'NB', 'E1A1A7', '1990-07-01', '111-111-117', '2011-07-01', '2011-07-01', 
'(506) 777-1111', '(506) 977-1111', 'grace.martin@example.com', 'HQ', 'Active'),

-- SD Employees under Frank (Supervisor 1)
('00000012', '00000006', 3, 10, '6afe6d7fc22bc59b1fa5b2c6749ddbb019b6e507a6ec7b0514cc631361b86635', 0x6E74EB8E9F01E582EE94FAE18D91DBD3, 'Leo', 
'Zimmer', 'H', '111 Queen St', 'Moncton', 'NB', 'E1A2A2', '1995-02-01', '111-111-122', '2016-02-01', '2016-02-01', 
'(506) 303-1111', '(506) 403-1111', 'leo.zimmer@example.com', 'HQ', 'Active'),

('00000015', '00000006', 3, 10, '1a2e155400ceab995e31122c019a4b427b1d268bee726a745189cc257860dbf7', 0xDAA7C1DC69DF180D964FBC15A5D276C7, 'Olivia', 
'Grant', 'J', '114 Queen St', 'Moncton', 'NB', 'E1A2A5', '1998-05-01', '111-111-125', '2019-05-01', '2019-05-01', 
'(506) 606-1111', '(506) 706-1111', 'olivia.grant@example.com', 'West Wing', 'Active'),

-- SD Employees under Grace (Supervisor 2)
('00000013', '00000007', 3, 14, '2c51fc521adf988f2f0a273acd43a68569791eec7f3acdac786f2ef439183bd6', 0xD74874CFA118F2C7581603F677AC2354, 'Mona', 
'Evans', 'I', '112 Queen St', 'Moncton', 'NB', 'E1A2A3', '1996-03-01', '111-111-123', '2017-03-01', '2017-03-01', 
'(506) 404-1111', '(506) 504-1111', 'mona.evans@example.com', 'East Wing', 'Inactive'),

('00000014', '00000007', 3, 10, '54171a646c261ee55f7abb95a2b48ae1d248f78d6c8970d7e21a67a21e3bee17', 0xE9C27C4B179E24445B1F548F607F8D4A, 'Nathan', 
'Ford', NULL, '113 Queen St', 'Moncton', 'NB', 'E1A2A4', '1997-04-01', '111-111-124', '2018-04-01', '2018-04-01', 
'(506) 505-1111', '(506) 605-1111', 'nathan.ford@example.com', 'East Wing', 'Active'),

-- IT OPERATIONS DEPARTMENT (ID: 4)
-- Infrastructure Manager (Supervisor 1 for IT dept)
('00000016', '00000001', 4, 6, '74d08c00d62f3170d5fe653b4a591f334e3b859b5185c4becba23ea0d8fc7510', 0x7D079DA13D2446ED8E6AA8F06F3810E1, 'Paul', 
'Harris', 'K', '115 Queen St', 'Moncton', 'NB', 'E1A2A6', '1999-06-01', '111-111-126', '2020-06-01', '2020-06-01', 
'(506) 707-1111', '(506) 807-1111', 'paul.harris@example.com', 'West Wing', 'Active'),

-- Infrastructure Manager (Supervisor 2 for IT dept)
('00000017', '00000001', 4, 6, '050395ff9d11eb8964974c719478276267c049ec6a2c3d3b9c58be6150705dbb', 0x6B5B6A3F2D1FC0CE2BD0F6907F4122BE, 'Quinn', 
'Irwin', NULL, '116 Queen St', 'Moncton', 'NB', 'E1A2A7', '2000-07-01', '111-111-127', '2021-07-01', '2021-07-01', 
'(506) 808-1111', '(506) 908-1111', 'quinn.irwin@example.com', 'HQ', 'Active'),

-- IT Employees under Paul (Supervisor 1)
('00000018', '00000016', 4, 12, '78368eaa4aa09b1a06adcc027b579cfce2ca0888044e8833b3967ac68993e8bc', 0x289FF3C6B4FC4171B5B4D96D41F16446, 'Rachel', 
'Jones', 'L', '117 Queen St', 'Moncton', 'NB', 'E1A2A8', '2001-08-01', '111-111-128', '2022-08-01', '2022-08-01', 
'(506) 909-1111', '(506) 109-1111', 'rachel.jones@example.com', 'North Office', 'Active'),

-- IT Employees under Quinn (Supervisor 2)
('00000019', '00000017', 4, 17, '1d30dea60908174511d284a26d06083c948a3fecbef0e4739bff7c675eadaa39', 0xA3D2C7FA5746B2D96F1DA147D3A165C6, 'Sam', 
'Kim', 'M', '118 Queen St', 'Moncton', 'NB', 'E1A2A9', '2002-09-01', '111-111-129', '2023-09-01', '2023-09-01', 
'(506) 110-1111', '(506) 210-1111', 'sam.kim@example.com', 'North Office', 'Active'),

('00000020', '00000017', 4, 13, '4700c0d519cc4eeb0ae1e0d84211fd10223d974c21297040015eb1749a26f8e2', 0xBBAEF8439A15704733F8E7D62186566C, 'Tina', 
'Lopez', 'N', '119 Queen St', 'Moncton', 'NB', 'E1A2B0', '2003-10-01', '111-111-130', '2024-10-01', '2024-10-01', 
'(506) 211-1111', '(506) 311-1111', 'tina.lopez@example.com', 'HQ', 'Active'),

-- BUSINESS SOLUTIONS DEPARTMENT (ID: 5) - Adding this department
-- Product Manager (Supervisor 1 for BS dept)
('00000021', '00000001', 5, 4, '24388386653dd1434991cb75d3669a8b7b8361c87986110575b4e88e35c66504', 0xE0187C6A4AD19746F368CFAA1FB93FCF, 'Victor', 
'Morgan', 'O', '120 Queen St', 'Moncton', 'NB', 'E1A2B1', '1985-11-01', '111-111-131', '2010-11-01', '2010-11-01', 
'(506) 212-1111', '(506) 312-1111', 'victor.morgan@example.com', 'HQ', 'Active'),

-- Product Manager (Supervisor 2 for BS dept)
('00000022', '00000001', 5, 4, 'a5b6d7c1bfbc023930e33f8b0f2658b782a80a19251e9885c6468cb823037930', 0x7D1384BECD09A7091F3CC453EE18A5FE, 'Wendy', 
'Parker', 'P', '121 Queen St', 'Moncton', 'NB', 'E1A2B2', '1986-12-01', '111-111-132', '2011-12-01', '2011-12-01', 
'(506) 213-1111', '(506) 313-1111', 'wendy.parker@example.com', 'HQ', 'Active'),

-- BS Employees under Victor (Supervisor 1)
('00000023', '00000021', 5, 9, 'b12db4f06d40c58197aee70dedda8ddfe23663d043306af1469f760af9da55e3', 0x5A6885A5C69A9D8FB337B21AC80D8016, 'Xavier', 
'Roberts', 'Q', '122 Queen St', 'Moncton', 'NB', 'E1A2B3', '1990-01-15', '111-111-133', '2015-01-15', '2015-01-15', 
'(506) 214-1111', '(506) 314-1111', 'xavier.roberts@example.com', 'East Wing', 'Active'),

-- BS Employees under Wendy (Supervisor 2)
('00000024', '00000022', 5, 18, 'c08724bac9e850482980b50b84710655f82c8c364b0619fc0febeaa04eed12f9', 0xB7B51BC0DC6D995B6D3D6A42D8D2DAD6, 'Yasmin', 
'Stevens', 'R', '123 Queen St', 'Moncton', 'NB', 'E1A2B4', '1991-02-15', '111-111-134', '2016-02-15', '2016-02-15', 
'(506) 215-1111', '(506) 315-1111', 'yasmin.stevens@example.com', 'West Wing', 'Active');
...
BEGIN
	BEGIN TRY
	BEGIN TRANSACTION
		INSERT INTO Employee(Id, SupervisorId, DepartmentId, JobAssignmentId, Password, PasswordSalt, FirstName, LastName, MiddleInitial,
			StreetAddress, City, Province, PostalCode, DOB, SIN, SeniorityDate, JobStartDate, WorkPhone, CellPhone, EmailAddress,
			OfficeLocation, EmploymentStatus
		)
		VALUES(@Id, @SupervisorId, @DepartmentId, @JobAssignmentId, @Password, @PasswordSalt, @FirstName, @LastName, @MiddleInitial, @StreetAddress,
		@City, @Province, @PostalCode, @DOB, @SIN, @SeniorityDate, @JobStartDate, @WorkPhone, @CellPhone, @EmailAddress, @OfficeLocation, @EmploymentStatus);
...
END
GO
--EXEC spSearchEmployee @EmployeeId = '00000001';
