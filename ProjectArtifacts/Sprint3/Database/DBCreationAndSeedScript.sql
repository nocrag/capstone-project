...
CREATE TABLE PurchaseOrderItem (
    ...
    ModificationReason VARCHAR(500)   NULL
...
('00000025', 1, '00000002', 1, 7, '24388386653dd1434991cb75d3669a8b7b8361c87986110575b4e88e35c66504', 0xE0187C6A4AD19746F368CFAA1FB93FCF, 'John', 
'Smith', 'R', '123 Main St', 'Fredericton', 'NB', 'E3B1C2', '1990-05-15', '222-333-444', '2025-05-16', '2025-05-16', 
'(506) 555-1234', '(506) 555-5678', 'john.smith@example.com', 'Branch Office', NULL, NULL),
...
'Zimmer', 'H', '111 Queen St', 'Moncton', 'NB', 'E1A2A2', '1959-02-01', '111-111-122', '2016-02-01', '2016-02-01', 
...
'Grant', 'J', '114 Queen St', 'Moncton', 'NB', 'E1A2A5', '1955-05-01', '111-111-125', '2019-05-01', '2019-05-01', 
...
'Evans', 'I', '112 Queen St', 'Moncton', 'NB', 'E1A2A3', '1955-03-01', '111-111-123', '2017-03-01', '2017-03-01', 
...
('00000101', '00000001', 0, '2024-06-01'),
('00000102', '00000001', 0, '2024-06-02'),
('00000103', '00000001', 0, '2024-07-03'),
('00000104', '00000001', 0, '2024-07-04'),
('00000105', '00000001', 0, '2024-07-05'),


('00000106', '00000008', 2, '2024-07-06'),
('00000107', '00000008', 2, '2024-07-07'),
('00000108', '00000008', 2, '2024-07-08'),
('00000109', '00000008', 0, '2024-07-09'),
('00000110', '00000008', 0, '2024-07-10'),
('00000111', '00000008', 0, '2024-08-11'),

('00000112', '00000025', 0, '2024-08-12'),
('00000113', '00000025', 0, '2024-08-13'),
('00000114', '00000025', 0, '2024-08-14'),
('00000115', '00000025', 0, '2024-09-15'),
('00000116', '00000025', 0, '2024-09-16'),
('00000117', '00000025', 0, '2024-09-17'),
('00000118', '00000025', 0, '2024-09-18'),
--
...
--
('00000140', '00000002', 2, '2025-02-11'),
('00000141', '00000002', 2, '2025-02-12'),
('00000142', '00000002', 2, '2025-02-13'),
('00000143', '00000002', 2, '2025-02-14'),
--
('00000144', '00000025', 0, '2025-02-15'),
('00000145', '00000025', 0, '2025-02-16'),
('00000146', '00000025', 0, '2025-02-17'),
('00000147', '00000025', 0, '2025-03-18'),
('00000148', '00000025', 0, '2025-03-19'),
('00000149', '00000025', 0, '2025-03-20'),
('00000150', '00000025', 0, '2025-03-21'),


('00000151', '00000004', 2, '2025-03-22'),
('00000152', '00000004', 2, '2025-03-23'),
('00000153', '00000004', 2, '2025-03-24'),
('00000154', '00000004', 2, '2025-04-25'),
('00000155', '00000004', 2, '2025-04-26'),
('00000156', '00000004', 2, '2025-04-27'),
('00000157', '00000004', 2, '2025-04-07'),
('00000158', '00000004', 2, '2025-05-08'),
('00000159', '00000004', 2, '2025-05-09'),


('00000160', '00000002', 2, '2025-05-10'),
('00000161', '00000002', 2, '2025-05-11'),
('00000162', '00000002', 2, '2025-05-12'),
('00000163', '00000002', 2, '2025-05-13'),
('00000164', '00000002', 2, '2025-05-14'),
('00000165', '00000002', 2, '2025-05-15'),
('00000166', '00000002', 2, '2025-05-16'),
('00000167', '00000002', 2, '2025-05-17'),
('00000168', '00000002', 2, '2025-05-18');
...
('00000106', 'Chair', 'USB-C chair', 3, 'Meeting room setup', 'Office Depot', 'Approved', 262.66),
('00000106', 'Camera', 'USB-C camera', 3, 'Replacement unit', 'Office Depot', 'Approved', 67.81),
('00000106', 'Stand', 'Compact stand', 3, 'Replacement unit', 'Amazon', 'Approved', 225.74),

('00000107', 'SSD', 'Adjustable ssd', 5, 'Meeting room setup', 'Newegg', 'Approved', 217.49),
('00000107', 'Router', 'High-end router', 1, 'Ergonomic setup', 'Newegg', 'Approved', 217.34),
('00000107', 'Tablet', 'USB-C tablet', 1, 'Meeting room setup', 'Staples', 'Approved', 195.35)
,
('00000108', 'Docking Station', 'USB-C docking station', 3, 'Replacement unit', 'Amazon', 'Approved', 225.72),
('00000108', 'Desk Lamp', 'Wireless desk lamp', 5, 'Ergonomic setup', 'Staples', 'Approved', 250.85),
('00000108', 'Speaker', 'USB-C speaker', 3, 'Replacement unit', 'Tech World', 'Approved', 150.07),
...
('00000140', 'Fire Extinguisher', 'ABC-rated with wall mount and inspection tag', 1, 'Safety requirement per building policy', 'Amazon', 'Approved', 105.29),
('00000140', 'Standing Desk Converter', 'Adjustable riser for dual monitor setup', 1, 'Ergonomic upgrade for seated desks', 'Amazon', 'Approved', 245.95),

('00000141', 'Pack of pens', 'Blue and red', 100, 'For meeting notes', 'Amazon', 'Approved', 11.99),
('00000141', 'Speakers', 'JBL Boombox 2', 1, 'For the office anual party', 'Bestbuy', 'Approved', 399.99),
('00000141', 'Plastic cups', '50ml with lid', 100, 'For coffee machine', 'Amazon', 'Approved', 15.99),

('00000142', 'Cable organizer', 'Colored ones', 100, 'For organizing my desk', 'Amazon', 'Approved', 12.99),
('00000142', 'Speakers', 'Logitech sound master', 1, 'For announcements', 'Bestbuy', 'Approved', 499.99),
('00000142', 'Plastic cups', '50ml with lid', 100, 'For coffee machine', 'Amazon', 'Approved', 15.99),

('00000143', 'Sunglasses', 'With polarized filter', 1, 'For use when visiting clients', 'Oakley website', 'Approved', 199.85),
('00000143', 'Monitor', 'Foldable portable', 1, 'For using on the field trip', 'Bestbuy', 'Approved', 299.99),
('00000143', 'Chairs', 'Black ones', 20, 'For the new break roon', 'Ikea', 'Approved', 59.99),
...
('00000144', 'Desk Lamp', 'LED lamp with touch control', 3, 'Improve lighting', 'Ikea', 'Pending', 24.99),
('00000144', 'USB Hub', '7-port USB 3.0 hub', 1, 'Connect multiple devices', 'Staples', 'Pending', 29.99),
...
('00000145', 'Whiteboard Markers', 'Dry erase markers', 2, 'Office supplies', 'Staples', 'Pending', 5.00),
('00000145', 'Webcam', '1080p HD webcam', 1, 'Virtual meetings', 'Amazon', 'Pending', 79.99),
('00000145', 'Ethernet Cable', '10m CAT6 cable', 2, 'Wired internet setup', 'Newegg', 'Pending', 14.95),
...
('00000146', 'Mouse Pad', 'Ergonomic mouse pad', 1, 'Wrist support', 'Walmart', 'Pending', 9.99),
('00000146', 'Smart Plug', 'Wi-Fi smart plug 2-pack', 1, 'Energy monitoring', 'Amazon', 'Pending', 22.99),


('00000147', 'Ergonomic Keyboard', 'Curved split-key keyboard with wrist rest', 1, 'To reduce wrist strain during long hours of typing.', 'Amazon', 'Pending', 89.99),
('00000147', 'Wireless Mouse', 'Rechargeable Bluetooth mouse with silent clicks', 2, 'For better mobility and convenience for remote staff.', 'BestBuy', 'Pending', 39.99),
('00000147', 'Legal Pads (12-pack)', 'Ruled yellow notepads, 50 sheets each', 1, 'Used during meetings for handwritten notes.', 'Staples', 'Pending', 18.49),
('00000147', 'Monitor Stand Riser', 'Adjustable-height stand for monitors', 1, 'Improves posture and reduces neck pain.', 'Newegg', 'Pending', 34.99),
('00000147', 'USB Flash Drive (64GB)', 'High-speed USB 3.0 flash drive', 3, 'To store and transfer important documents.', 'Walmart', 'Pending', 14.99),

('00000148', 'Label Maker', 'Handheld printer with QWERTY keyboard', 1, 'Used for labeling files and equipment.', 'Amazon', 'Pending', 49.95),
('00000148', 'Whiteboard Starter Kit', 'Includes markers, eraser, and cleaner', 1, 'Required for team brainstorming in meeting rooms.', 'Staples', 'Pending', 22.50),
('00000148', 'Desk Organizer Tray Set', '5-piece mesh metal organizer set', 2, 'Helps keep desks clutter-free and efficient.', 'Ikea', 'Pending', 19.95),
('00000148', 'Stapler & Staples Pack', 'Heavy-duty stapler with 2000 staples', 1, 'For binding physical reports and internal documents.', 'Office Depot', 'Pending', 12.75),
('00000148', 'Noise-Canceling Headphones', 'Over-ear wireless headphones with ANC', 1, 'Helps staff concentrate in shared spaces.', 'BestBuy', 'Pending', 109.99),

('00000149', 'Printer Paper (Case)', 'Case of 10 reams, 500 sheets each', 1, 'Restock for shared office printers.', 'Walmart', 'Pending', 54.99),
('00000149', 'Adjustable Foot Rest', 'Ergonomic under-desk foot rest with height adjustment', 1, 'Improves comfort and circulation during long sitting hours.', 'Amazon', 'Pending', 29.99),
('00000149', 'Dry Erase Whiteboard', 'Magnetic wall-mount whiteboard, 36x24 inches', 1, 'For project planning and team updates in shared workspace.', 'Staples', 'Pending', 64.95),
('00000149', 'Shredder', 'Cross-cut shredder for confidential documents', 1, 'Required for securely disposing of sensitive paperwork.', 'BestBuy', 'Pending', 89.50),

('00000150', 'Conference Speakerphone', 'USB speakerphone with noise cancellation for meetings', 1, 'Improves audio quality during virtual conferences.', 'Amazon', 'Pending', 129.99),
('00000150', 'Filing Cabinet', '2-drawer vertical filing cabinet with lock', 1, 'Used to organize and secure physical documents.', 'Ikea', 'Pending', 149.00),
('00000150', 'Laminating Machine', 'Thermal laminator with starter pack', 1, 'For protecting signs, ID cards, and documents.', 'Staples', 'Pending', 59.95),
('00000150', 'Power Strip Tower', '10-outlet surge protector with USB ports', 1, 'To power multiple workstations with surge protection.', 'Newegg', 'Pending', 39.95),


-- PO 00000151
('00000151', 'Stapler', 'Standard size', 2, 'For daily office use', 'Office Depot', 'Approved', 15.99),
('00000151', 'Printer Paper', '500 sheets per ream', 5, 'Monthly printing needs', 'Staples', 'Approved', 6.49),
('00000151', 'Desk Organizer', 'Wooden, 3 compartments', 1, 'To organize desks', 'Amazon', 'Approved', 23.75),
('00000151', 'Whiteboard Markers', 'Pack of 6 assorted colors', 3, 'For meeting rooms', 'OfficeMax', 'Approved', 12.30),

-- PO 00000152
('00000152', 'Mouse Pad', 'Ergonomic design', 4, 'Improve workstation comfort', 'Best Buy', 'Approved', 9.99),
('00000152', 'USB Flash Drive', '64GB capacity', 10, 'For quick data transfer', 'Newegg', 'Approved', 12.50),
('00000152', 'Desk Lamp', 'LED adjustable', 2, 'Additional lighting for desks', 'Ikea', 'Approved', 35.00),
('00000152', 'Notebook', 'A5 size, ruled', 15, 'For note-taking', 'Staples', 'Denied', 4.20),

-- PO 00000153
('00000153', 'Calculator', 'Scientific model', 3, 'For accounting department', 'Amazon', 'Approved', 29.95),
('00000153', 'Paper Clips', 'Box of 1000', 4, 'Organizing documents', 'Office Depot', 'Approved', 5.40),
('00000153', 'Desk Chair', 'Adjustable height', 1, 'Replacement for broken chair', 'Ikea', 'Approved', 120.00),
('00000153', 'Pen Set', 'Ballpoint, pack of 12', 5, 'Office supplies', 'Staples', 'Approved', 14.50),

-- PO 00000154
('00000154', 'Binder Clips', 'Large pack', 6, 'File management', 'OfficeMax', 'Approved', 7.90),
('00000154', 'Sticky Notes', '3x3 inches, 12 pads', 8, 'Reminders and notes', 'Amazon', 'Approved', 10.80),
('00000154', 'Desk Calendar', '2025 edition', 3, 'Scheduling', 'Staples', 'Denied', 13.25),
('00000154', 'Trash Bin', 'Small office size', 2, 'Office cleanliness', 'Home Depot', 'Approved', 18.00),

-- PO 00000155
('00000155', 'Headphones', 'Noise-cancelling', 2, 'For video calls', 'Best Buy', 'Approved', 75.00),
('00000155', 'USB Hub', '4 ports', 4, 'Expand computer connectivity', 'Amazon', 'Approved', 20.00),
('00000155', 'File Folders', 'Pack of 50', 10, 'Organizing paperwork', 'Office Depot', 'Approved', 22.50),
('00000155', 'Label Maker', 'Portable device', 1, 'Label office supplies', 'Staples', 'Approved', 45.00),

-- PO 00000156
('00000156', 'Desk Fan', 'USB powered', 3, 'Improve desk comfort', 'Amazon', 'Approved', 25.00),
('00000156', 'Paper Cutter', '12-inch blade', 1, 'Cutting paper stacks', 'OfficeMax', 'Approved', 32.00),
('00000156', 'Markers', 'Permanent, pack of 8', 5, 'Labeling items', 'Staples', 'Approved', 14.75),
('00000156', 'Mouse', 'Wireless, ergonomic', 4, 'For computer users', 'Best Buy', 'Denied', 22.50),

-- PO 00000157
('00000157', 'Clipboard', 'Standard size', 7, 'Document handling', 'Office Depot', 'Approved', 9.00),
('00000157', 'Desk Pad', 'Leatherette', 3, 'Protect desks', 'Amazon', 'Approved', 29.99),
('00000157', 'Paper Tray', '3-tier organizer', 4, 'Organize incoming papers', 'Ikea', 'Approved', 18.50),
('00000157', 'Scissors', '8 inch stainless steel', 5, 'Cutting needs', 'OfficeMax', 'Denied', 8.25),

-- PO 00000158
('00000158', 'Calculator Paper Rolls', 'Pack of 10', 8, 'For calculators and cash registers', 'Staples', 'Approved', 15.00),
('00000158', 'Pen Holder', 'Desk organizer', 5, 'Hold pens and pencils', 'Amazon', 'Approved', 11.75),
('00000158', 'Whiteboard Eraser', 'Magnetic', 6, 'For whiteboard cleaning', 'Office Depot', 'Approved', 7.00),
('00000158', 'Extension Cord', '6 feet', 4, 'Power supply extension', 'Home Depot', 'Approved', 19.99),

-- PO 00000159
('00000159', 'Packing Tape', 'Clear, 2 inch wide', 12, 'Packaging needs', 'OfficeMax', 'Approved', 3.50),
('00000159', 'Rubber Bands', 'Pack of 500', 6, 'Organizing documents', 'Staples', 'Approved', 4.25),
('00000159', 'Desk Clock', 'Analog', 3, 'Time management', 'Amazon', 'Approved', 22.99),
('00000159', 'Staple Remover', 'Standard size', 5, 'Remove staples easily', 'Office Depot', 'Approved', 6.75),
...
-- PO 00000160
('00000160', 'Binder', '3-ring, 2 inch', 8, 'Organizing reports', 'Staples', 'Approved', 9.99),
('00000160', 'Highlighter Set', 'Pack of 5 assorted colors', 7, 'Highlighting documents', 'Amazon', 'Approved', 8.50),
('00000160', 'Desk Organizer', 'Plastic, multi-compartment', 3, 'Office desk organization', 'Office Depot', 'Approved', 15.00),
('00000160', 'Wireless Keyboard', 'Compact layout', 2, 'Improved typing experience', 'Best Buy', 'Approved', 40.00),

-- PO 00000161
('00000161', 'Monitor Stand', 'Adjustable height', 4, 'Better ergonomics', 'Ikea', 'Approved', 30.00),
('00000161', 'USB-C Cable', '6 feet length', 10, 'Device charging and data transfer', 'Amazon', 'Approved', 10.00),
('00000161', 'Notebook', 'A4 size, dotted', 12, 'For meeting notes', 'Staples', 'Approved', 6.00),
('00000161', 'Pen Set', 'Gel ink, pack of 10', 6, 'Writing supplies', 'OfficeMax', 'Approved', 12.00),

-- PO 00000162
('00000162', 'Desk Lamp', 'LED, adjustable', 3, 'Task lighting', 'Ikea', 'Approved', 35.00),
('00000162', 'Mouse', 'Wireless ergonomic', 5, 'Computer input', 'Best Buy', 'Approved', 25.00),
('00000162', 'File Cabinet', '3 drawers, locking', 2, 'Secure file storage', 'Office Depot', 'Approved', 150.00),
('00000162', 'Sticky Notes', 'Assorted sizes, pack of 10', 6, 'Quick notes', 'Amazon', 'Approved', 12.00),

-- PO 00000163
('00000163', 'Headphones', 'Over-ear, noise cancelling', 2, 'Virtual meetings', 'Best Buy', 'Approved', 85.00),
('00000163', 'Paper Shredder', 'Cross-cut', 1, 'Document disposal', 'OfficeMax', 'Approved', 120.00),
('00000163', 'Desk Chair', 'Ergonomic mesh', 3, 'Comfortable seating', 'Ikea', 'Approved', 130.00),
('00000163', 'Whiteboard', 'Magnetic, 4x6 ft', 2, 'Meeting rooms', 'Staples', 'Approved', 90.00),

-- PO 00000164
('00000164', 'Calculator', 'Desktop, solar powered', 4, 'Accounting tasks', 'Office Depot', 'Approved', 25.00),
('00000164', 'Pen Holder', 'Metal mesh', 5, 'Desk organization', 'Amazon', 'Approved', 10.00),
('00000164', 'Desk Pad', 'Leatherette, 24x20 inches', 3, 'Desk protection', 'Staples', 'Approved', 30.00),
('00000164', 'Extension Cord', '12 feet', 4, 'Power extension', 'Home Depot', 'Approved', 22.00),

-- PO 00000165
('00000165', 'Label Maker', 'Handheld device', 1, 'Organizing office items', 'Staples', 'Approved', 45.00),
('00000165', 'File Folders', 'Colored, pack of 50', 8, 'Organizing paperwork', 'OfficeMax', 'Approved', 20.00),
('00000165', 'Desk Fan', 'USB powered', 3, 'Cooling workspace', 'Amazon', 'Approved', 25.00),
('00000165', 'Notebook', 'Hardcover, ruled', 12, 'Note-taking', 'Staples', 'Approved', 7.50),

-- PO 00000166
('00000166', 'Desk Organizer', 'Wooden, multi-compartment', 2, 'Improve desk tidiness', 'Amazon', 'Approved', 28.00),
('00000166', 'Wireless Mouse', 'Ergonomic, Bluetooth', 4, 'Computer use', 'Best Buy', 'Approved', 23.50),
('00000166', 'Notebook', 'A5 size, lined', 10, 'Meeting notes', 'Staples', 'Approved', 5.75),
('00000166', 'Desk Lamp', 'LED adjustable', 3, 'Better lighting', 'Ikea', 'Approved', 35.00),

-- PO 00000167
('00000167', 'File Cabinet', '2 drawers, locking', 1, 'Secure document storage', 'Office Depot', 'Approved', 120.00),
('00000167', 'Sticky Notes', '3x3 inch, assorted colors', 12, 'Reminders', 'Amazon', 'Approved', 11.50),
('00000167', 'Pen Set', 'Gel ink, pack of 12', 6, 'Office supplies', 'Staples', 'Approved', 14.00),
('00000167', 'Desk Chair', 'Ergonomic, mesh back', 2, 'Comfortable seating', 'Ikea', 'Approved', 140.00),

-- PO 00000168
('00000168', 'Headphones', 'Over-ear, noise cancelling', 3, 'Video conferences', 'Best Buy', 'Approved', 80.00),
('00000168', 'Whiteboard Markers', 'Pack of 8 assorted colors', 4, 'Meeting rooms', 'OfficeMax', 'Approved', 15.00),
('00000168', 'USB-C Hub', '6 ports', 3, 'Expand connectivity', 'Amazon', 'Approved', 35.00),
('00000168', 'Desk Pad', 'Leatherette, large', 2, 'Desk protection', 'Staples', 'Approved', 30.00);
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- ✅ Only check if PO is still open
        IF EXISTS (
            SELECT 1
            FROM PurchaseOrder
        ...
        BEGIN
            THROW 50002, 'Cannot add item. The purchase order is already closed.', 1;
        END
        INSERT INTO PurchaseOrderItem (
            PurchaseOrderId,
            Name,
...
--SELECT * FROM PurchaseOrderItem WHERE Id = 64
...
BEGIN
    ...
    DECLARE @CurrentQuarter INT = DATEPART(QUARTER, @CurrentDate);
    ...
    -- Validate that the quarter has ended
    IF (@Year > @CurrentYear) OR (@Year = @CurrentYear AND @Quarter >= @CurrentQuarter)
    BEGIN
        SET @ErrorMessage = 'Reviews can only be added for quarters that have already ended.';
        RAISERROR(@ErrorMessage, 16, 1);
        RETURN;
    END
    ...
    INSERT INTO EmployeeReview (EmployeeId, RatingOptionsId, Comment, ReviewDate, Quarter)
    VALUES (@EmployeeId, @RatingOptionsId, @Comment, @ReviewDate, @Quarter);
...
BEGIN
	...
	RatingOptions.Rating, EmployeeReview.Comment, EmployeeReview.ReviewDate, EmployeeReview.Quarter
...
CREATE OR ALTER PROCEDURE spGetMonthlyExpensesForSupervisor
    @SupervisorId CHAR(8)
AS
BEGIN
    SET NOCOUNT ON;
    ...
    ;WITH Months AS (
        SELECT 
            FORMAT(DATEADD(MONTH, -11, DATEFROMPARTS(YEAR(GETDATE()), MONTH(GETDATE()), 1)), 'yyyy-MM') AS MonthValue,
            DATEADD(MONTH, -11, DATEFROMPARTS(YEAR(GETDATE()), MONTH(GETDATE()), 1)) AS MonthStart
        UNION ALL
        SELECT 
    ...
    POData AS (
        SELECT
            FORMAT(po.DateCreated, 'yyyy-MM') AS [Month],
            COUNT(DISTINCT po.PurchaseOrderId) AS POCount,
             ROUND(SUM(poi.Price * poi.Quantity * 1.15), 2) AS [Total]
        FROM Employee emp
        INNER JOIN PurchaseOrder po ON emp.Id = po.EmployeeId
        INNER JOIN PurchaseOrderItem poi ON po.PurchaseOrderId = poi.PurchaseOrderId
        WHERE emp.DepartmentId = (SELECT DepartmentId FROM Employee WHERE Id = @SupervisorId)
          AND po.Status = 2               
          AND poi.ItemStatus = 'APPROVED'
          AND po.DateCreated >= DATEADD(MONTH, -11, DATEFROMPARTS(YEAR(GETDATE()), MONTH(GETDATE()), 1))
        GROUP BY FORMAT(po.DateCreated, 'yyyy-MM')
    )

    SELECT
        m.MonthValue AS [Month],
        ISNULL(p.POCount, 0) AS POCount,
        ISNULL(p.Total, 0) AS [Total]
    FROM Months m
    LEFT JOIN POData p ON p.Month = m.MonthValue
...
--EXEC spGetMonthlyExpensesForSupervisor @SupervisorId='00000002'
--EXEC spGetMonthlyExpensesAndCountsForEmployee @EmployeeId='00000002'


CREATE OR ALTER PROCEDURE spGetMonthlyExpensesAndCountsForEmployee
    @EmployeeId CHAR(8)
AS
BEGIN
    SET NOCOUNT ON;
    ...
    ;WITH Months AS (
        SELECT 
            CONVERT(CHAR(7), DATEADD(MONTH, -11, GETDATE()), 120) AS MonthValue,
            DATEADD(MONTH, -11, DATEFROMPARTS(YEAR(GETDATE()), MONTH(GETDATE()), 1)) AS MonthStart
        UNION ALL
        SELECT 
            CONVERT(CHAR(7), DATEADD(MONTH, 1, MonthStart), 120),
            DATEADD(MONTH, 1, MonthStart)
        FROM Months
        WHERE MonthStart < DATEFROMPARTS(YEAR(GETDATE()), MONTH(GETDATE()), 1)
    ),
    ...
    POData AS (
        SELECT
            CONVERT(CHAR(7), po.DateCreated, 120) AS [Month],
            COUNT(DISTINCT po.PurchaseOrderId) AS POCount,
            ROUND(SUM(poi.Price * poi.Quantity * 1.15), 2) AS [Total]
        FROM PurchaseOrder po
        INNER JOIN PurchaseOrderItem poi ON po.PurchaseOrderId = poi.PurchaseOrderId
        WHERE po.EmployeeId = @EmployeeId
          ...
          AND poi.ItemStatus = 'APPROVED'                  
          AND po.DateCreated >= DATEADD(MONTH, -11, DATEFROMPARTS(YEAR(GETDATE()), MONTH(GETDATE()), 1))
        GROUP BY CONVERT(CHAR(7), po.DateCreated, 120)
    )
...
CREATE OR ALTER PROCEDURE spGetPurchaseOrderApiSummary
...
BEGIN
    ...
    SELECT 
        ...
        COUNT(CASE WHEN poi.ItemStatus <> 'Denied' THEN 1 END) AS TotalItems,
        ROUND(SUM(CASE WHEN poi.ItemStatus <> 'Denied' THEN poi.Price * poi.Quantity ELSE 0 END) * 1.15, 2) AS GrandTotal
    FROM PurchaseOrder po
    INNER JOIN Employee emp ON po.EmployeeId = emp.Id
    LEFT JOIN Employee sup ON emp.SupervisorId = sup.Id
    LEFT JOIN PurchaseOrderItem poi ON po.PurchaseOrderId = poi.PurchaseOrderId
    WHERE po.PurchaseOrderId = @PurchaseOrderId
    GROUP BY po.PurchaseOrderId, po.Status, sup.FirstName, sup.LastName;
END

--SELECT * FROM PurchaseOrderItem WHERE Id = 67
